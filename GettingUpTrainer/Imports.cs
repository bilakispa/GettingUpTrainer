...
namespace GettingUpTrainer
{
    ...
    { // READ FLAGS
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool ReadProcessMemory(IntPtr hProcess, int lpBaseAddress, [In, Out] byte[] lpBuffer, UInt32 dwSize, out IntPtr lpNumberOfBytesRead);
        ...
        //Below: Used for checking if window is fullscreen
        [DllImport("user32.dll")]
